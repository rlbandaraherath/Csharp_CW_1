...
namespace CW_1
{
    public partial class admin_approved_jobs : Form
    {

        SqlDataAdapter adpt;
        DataTable dt;

        public admin_approved_jobs()
        {
            InitializeComponent();
        }
       //Establishing the DataBase connection
        ...
        // view data in a gridview
        private void admin_approved_jobs_Load(object sender, EventArgs e)
        {
